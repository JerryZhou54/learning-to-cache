...
def main(args):
    ...
    model.load_state_dict(torch.load("/data/hyou37_data/learning-to-cache/DiT/results/001-DiT-XL-2/checkpoints/0104000.pt", map_location=lambda storage, loc: storage)["model"], strict=False)
    kept_mod_ratios = []
    for i in range(28):
